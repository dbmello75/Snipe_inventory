...
# type == disk
#
# For display we keep model/serial/size/interface.
# For change detection, serials are used as primary identity.
# =========================================================
...
# =========================================================
# EXTRACT STORAGE SERIALS FROM CURRENT SNIPE VALUE
# =========================================================
...
if [ "$CURRENT_STORAGE_SERIALS" != "$STORAGE_SERIALS" ]; then
    ...
    echo
    echo "  Storage serials changed:"
    echo "  OLD: ${CURRENT_STORAGE_SERIALS:-<none>}"
    echo "  NEW: ${STORAGE_SERIALS:-<none>}"
